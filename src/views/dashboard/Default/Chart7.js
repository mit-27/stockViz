...
const Chart7 = () => {
    ...
    return (
        <Box mt={3}>
            <Container>
                <TableauGraph sourceURL="https://public.tableau.com/views/InsightsforAequitasData_/Sheet3?:language=en-GB&publish=yes&:display_count=n&:origin=viz_share_link"/>
            </Container>
        </Box>
